...
to $[0,A]$ where $A=t-s$ without changing the average power consumption.   \philippend
...
\def\svgwidth{0.95\textwidth} \scriptsize{
  \input{galphaDalpha.pdf_tex}}
  \caption{Optimal height and average distortion for $N=2,A=1$ and uniform GT density.}
  \label{fig:goptdopt}
\end{minipage}
\hfill
