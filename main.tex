...
\end{abstract}
%
\section{Introduction}\blfootnote{This work was supported in part by the NSF Award CCF-1815339.}
...
\subsection{The optimal parameter quantizer in one-dimension for uniform density}
